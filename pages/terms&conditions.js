...
export default function Privacy() {
	return (
		<div>
			<Head>
				<title>Panorama - Terms And Conditions</title>
          ...
          "
			...
			<FAQPrivacy data="Terms And Conditions"/>
			<div className="faq">
				<div className="fra">
					<Container maxWidth="xl">
						<Grid container spacing={0}>
							<Grid md={6} style={{ paddingTop: "24px" }}>
								...
								<br />
								<br />
                                <a href="/Panorama Terms and Conditions Bangladesh.pdf">
								...
								<br />
								<br />
								<a href="/Panorama Terms and Conditions Panorama USA.pdf"><Typography variant="large" color="neutral.b800">
