...
export default function Privacy() {
	return (
		<div>
			<Head>
				<title>Panorama - Privacy Policy</title>
          ...
          "
			...
			<FAQPrivacy data="Privacy Policy"/>
			<div className="faq">
				<div className="fra">
					<Container maxWidth="xl">
						<Grid container spacing={0}>
							<Grid md={6} style={{ paddingTop: "24px" }}>
								...
								<br />
								<br />
								<a href="/Panorama Privacy Policy Website USA.pdf"><Typography variant="large" color="neutral.b800">
